...
App.controller('gridPage2Ctrl', ['$scope', '$http','$timeout', function ($scope, $http,$timeout) {
        $scope.gridOption1 =
        {
            pageSize: 20,
            height: 450,
            ...
            columns: [{
                ...
                field: "cpu",
                title: "cpu(多列下拉)",
                width: 450,  // 宽度只能这样设置了 就用户自己设置数值就好了
                editorConfig: {
        ...
        $scope.throwException = function () {
            $http({
                url: "GridDemoService/throwException.json",
                method: "GET"
            }).success(function (data, status, header, config) {
